    ...
    def post(self, request):
        try:
            ...
            if server_type == "server":
                ...
                if data is not None and data[0] == True and data[1] == "Board Name Already Exists":
                ...
                elif data is not None and data[0] == False:
            ...
            logger.error(f"Error in JiraProjectRegistrationView: {e}", exc_info=True)
